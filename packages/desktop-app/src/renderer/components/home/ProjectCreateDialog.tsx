...
export function ProjectCreateDialog({ open, onClose, onCreate }: ProjectCreateDialogProps): JSX.Element {
  ...
  return (
    <Modal open={open} onClose={onClose} title="Create Project" footer={footer} width={480}>
      <div className="flex flex-col gap-4">
        <div>
          <label className="mb-1 block text-xs text-secondary">Project Name</label>
          <Input
            value={name}
        ...
        <div>
          <label className="mb-1 block text-xs text-secondary">Project Folder</label>
