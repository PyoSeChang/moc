...
export const TagInput: React.FC<TagInputProps> = ({ value = [], onChange, placeholder = 'Add tag...', disabled }) => {
  ...
  return (
    <div className="flex flex-wrap items-center gap-1 px-2 py-1.5 bg-input border border-input rounded-lg min-h-[34px] focus-within:border-accent focus-within:ring-2 focus-within:ring-accent-ring transition-all">
      {value.map((tag) => (
        <span
          key={tag}
